dataViewerControllers.controller('CampaignSummaryReportViewController', ['$scope', '$timeout', 'StorageService', 'DonationCampaignService', 'DonationFormService', 'DonationService', 'DateRangePickerService', 'DataTableService', function($scope, $timeout, StorageService, DonationCampaignService, DonationFormService, DonationService, DateRangePickerService, DataTableService) {
  $.AdminLTE.layout.fix();
  ...
  var getDonationSums = function(options) {
    ...
    DonationService.getDonations({
      ...
      success: function(donations) {
        if($scope.$location.path() === '/report-campaign-summary') {
